...
* Follow instructions on [this page](https://wowchemy.com/docs/install-locally/) to install hugo and dependencies. Here is a [link to the release we use](https://github.com/gohugoio/hugo/releases/tag/v0.74.2), you may be able to use a diffrent version, but try this version first if you have errors.
