...
abstract: As improvements in DNA synthesis technology and assembly methods make combinatorial
  ...
  genetic designs with ``variable'' components that can be implemented by choosing
  one of many linked designs for existing genetic parts or constructs. We demonstrate
